...
(function ($, window, document, undefined) {
    ...
    $form.submit(function (e) {
        ...
        var formData = {
            ...
            'appname' : $('input[name="form-appname"]').val(),
            'package' : $('input[name="form-package"]').val(),
            'apptype' : $('input[name="form-apptype"]').val(),
        ...
        $.ajax({
            ...
            if (!data.success) {
                ...
                if (data.errors.subject) {
                    ...
                    $('#phone-field').find('.col-lg-10').append('<span class="help-block">' + data.errors.subject + '</span>');
                }
